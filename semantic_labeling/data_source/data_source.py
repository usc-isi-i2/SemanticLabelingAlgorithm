...
class Attribute:
    ...
    def predict_type(self, set_name, labeled_sources, labeled_attrs_map, classifier, confidence_score=0.2):
        ...
        for prediction in predictions:
            if prediction["semantic_type"] in semantic_type_set or prediction["prob"] < confidence_score:
                continue
            else:

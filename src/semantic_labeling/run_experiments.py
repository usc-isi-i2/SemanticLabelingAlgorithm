...
class SemanticLabeler:
    ...
    def test_semantic_typing2(self, labeled_set, labeling_set):
        ...
        print data_set.test_with_different_set(self.classifier, labeled_set, labeled_sources)
...
if __name__ == "__main__":
    ...
    # labeler.test_semantic_typing1({"weather_old2": [1, 2, 3]})
    # labeler.test_semantic_typing1({"museum2": [5]})
    # labeler.test_semantic_typing1({"city2": [1, 2, 3, 4, 5]})
    labeler.test_semantic_typing1({"museum2": [10]})
